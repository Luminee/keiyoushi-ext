...
filter_keywords = ['11toon', '3Hentai', '3600000 Beauty', '6Manhua', '92Manhua', 'AHottie', 'Akuma', 'Baimangu (Darpou)', 'Baka Manhua', 'BaoBua', 'Baozi Manhua', 'Bato.to', 'BH3', 'BlackToon', 'Cartoon18', 'CartoonMad', 'COLAMANGA', 'Comicabc', 'Comico', 'Comics Valley', 'Comic Growl', 'Comic Fury', 'Comicz.net v2', 'Coomer', 'Danbooru', 'DeviantArt', 'Dragon Ball Multiverse', 'Dumanwu', 'E-Hentai', 'Goda', 'Hachiraw', 'Hanime1', 'Happymh', 'HentaiEra', 'HentaiFox', 'HentaiHand', 'Hitomi', 'IMHentai', 'Komga', 'Komiic', 'Luscious', 'Manga Ball', 'Manga18Me', 'MangaPark', 'MangaRaw', 'MangaReader', 'MangaToon (Limited)', 'Manhuaren', 'Manhuawu', 'Manhwa-raw', 'Manhwa18.cc', 'Manhwa Raw', 'Manhwa Toon', 'Manwa', 'ManyToonClub', 'Meitua.top', 'Miaoqu Manhua', 'MH1234', 'MyReadingManga', 'MyComic', 'NewToki / ManaToki', 'NHentai', 'nHentai.com (unoriginal)', 'NovelCrow', 'NovelCool', 'NoyAcg', 'PandaChaika', 'Picacomic', 'Pixiv', 'PornComix', 'PornPics', 'Raw18', 'RawDEX', 'Roumanwu', 'Rumanhua', 'Simply Hentai', 'Terra Historicus', 'Tongli', 'Toptoon.net', 'vomic', 'Wolf.com', 'xkcd', 'Yidan Girl', 'YKMH', 'Zaimanhua', 'Zazhimi']
